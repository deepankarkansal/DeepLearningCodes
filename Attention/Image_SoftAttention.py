...
def train_step(img_tensor, target, encoder, decoder):
  ...
  return loss, total_loss, encoder, decoder
...
def train_data(dataset, encoder, decoder, EPOCHS=10):
  loss_plot = []
  for epoch in range(EPOCHS):
      ...
      for (batch, (img_tensor, target)) in enumerate(dataset):
          batch_loss, t_loss, encoder, decoder = train_step(img_tensor, target, encoder, decoder)
          total_loss += t_loss
  ...
  return loss_plot, encoder, decoder
...
loss_plot, encoder, decoder = train_data(dataset, encoder, decoder, 10)

plotting_loss(loss_plot)

loss_plot1, encoder, decoder = train_data(dataset, encoder, decoder, 40)

plotting_loss(loss_plot.append(loss_plot1))

loss_plot, encoder, decoder = train_data(dataset, encoder, decoder, 50)
plotting_loss(loss_plot)
